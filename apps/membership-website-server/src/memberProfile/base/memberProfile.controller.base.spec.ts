...
const service = {
  ...
  memberProfiles: () => FIND_MANY_RESULT,
  memberProfile: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("MemberProfile", () => {
  ...
  test("POST /memberProfiles", async () => {
  ...
  test("GET /memberProfiles/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/memberProfiles"}/${nonExistingId}`)
  ...
  test("GET /memberProfiles/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/memberProfiles"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /memberProfiles existing resource", async () => {
